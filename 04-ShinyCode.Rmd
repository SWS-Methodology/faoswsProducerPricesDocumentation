# **The Producer prices validation Shiny R code** {#ShinyCode}
...
The 'Link table', the 'Balancing elelements' and the 'Extraction rates' are additional working tabs where the user can modify the SWS datatables directly from the shiny.
...
The 'Link table' tab is very simple, it pulls the SWS data table `link_table` and updates it when the user click the 'Update table button'.
